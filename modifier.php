...
?>
        ...
        <div class="tabUser">
            ...
            <div>
                <a class="" href="supprimer.php?email=<?=urlencode($userDetails['email'])?>">Supprimer</a>
                <?php 
                if($userDetails['role'] == 'ban'){
                    echo '<a class="" href="bannir.php?email='. urlencode($userDetails['email']) . '&amp;role=' . urlencode($userDetails['role']) .'">Débannir</a>';
                }
                else{
                    echo '<a class="" href="bannir.php?email='. urlencode($userDetails['email']) . '&amp;role=' . urlencode($userDetails['role']) .'">Bannir</a>';
                }
                ?>
            </div>
