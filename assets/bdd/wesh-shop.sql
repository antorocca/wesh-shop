...
CREATE TABLE `subcategory` (
  `id` int(11) NOT NULL,
  `nomSubCat` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `subcategory` (`id`, `nomSubCat`) VALUES
(1, 'Short');
...
(41, 'm@gmail.com', 'Monsieur-m', 'prenom-m', '$2y$10$wAoubwL8MlG4kFL6CbGq.eYLtb5bLpWcNVxDH54rIunMlOBRmJEry', 'rue m', 'ville-M', 'user'),
(42, 'k@gmail.com', 'Monsieur-k', 'prenom-k', '$2y$10$wm5eKPI3P26HtQKxGTU5xeqol2pZwMsJ92qpiOLvshkOqRy5meMmS', 'rue k', 'villeK', 'user');
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `fk_cat` FOREIGN KEY (`idCat`) REFERENCES `category` (`id`),
  ADD CONSTRAINT `fk_subCat` FOREIGN KEY (`idSubCat`) REFERENCES `subcategory` (`id`);
